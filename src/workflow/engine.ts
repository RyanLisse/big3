...
export class WorkflowEngine {
   ...
   */
  async executePlan(planId: string, config?: CreatePlanConfig): Promise<WorkflowPlan> {
    return Effect.runPromise(Effect.gen(this, function* (_) {
      ...
      for (const step of plan.steps) {
        ...
        try {
          const result = yield* _(Effect.tryPromise(() => this.executeStep(step, stepContext)));
          results.push({
            ...step,
            status: 'completed',
            output: result,
   ...
   */
  private async executeAgentInitialization(step: WorkflowStep, context: WorkflowContext): Promise<any> {
   ...
   */
  private async executeModelValidation(step: WorkflowStep, context: WorkflowContext): Promise<any> {
   ...
   */
  private async executeAgentCreation(step: WorkflowStep, context: WorkflowContext): Promise<any> {
   ...
   */
  private async executeCommunication(step: WorkflowStep, context: WorkflowContext): Promise<any> {
   ...
   */
  private async executeCheckpoint(step: WorkflowStep, context: WorkflowContext): Promise<any> {
   ...
   */
  private async executeRecovery(step: WorkflowStep, context: WorkflowContext): Promise<any> {
   ...
   */
  private async loadPlan(planId: string): Promise<WorkflowPlan | null> {
   ...
   */
  private async savePlan(plan: WorkflowPlan): Promise<void> {
