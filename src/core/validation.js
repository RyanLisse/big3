 ...
 */
export function validateAgentCreation(request) {
  const errors = [];
 ...
 */
function validateAgentConfigInternal(config) {
  const errors = [];
 ...
 */
function validateCommunicationConfig(comm) {
  const errors = [];
 ...
 */
function validateWebSocketConfig(ws) {
  const errors = [];
 ...
 */
function validateBatchingConfig(batch) {
  const errors = [];
 ...
 */
export function validateCreateTeamRequest(request) {
  return CreateTeamRequestSchema.safeParse(request);
}
export function validateUpdateTeamRequest(request) {
  return UpdateTeamRequestSchema.safeParse(request);
}
export function validateTeamMembershipRequest(request) {
  return TeamMembershipRequestSchema.safeParse(request);
}
export function validateCreateSharedMemoryRequest(request) {
  return CreateSharedMemoryRequestSchema.safeParse(request);
}
export function validateUpdateSharedMemoryRequest(request) {
