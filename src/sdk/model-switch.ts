...
import { ModelProvider, PerformanceMode } from './models'
  ...
  public getCurrentModel(): string {
    if (this.currentIndex >= this.fallbackChain.length) {
      throw new ModelError(
        ...
        { currentIndex: this.currentIndex, chainLength: this.fallbackChain.length }
      )
    }
 ...
 */
export function createModelSwitchManager(config: ModelSwitchConfig): ModelSwitchManager {
 ...
 */
export interface ModelSwitchMetrics {
 ...
 */
export function getModelSwitchMetrics(manager: ModelSwitchManager): ModelSwitchMetrics {
