...
describe('Navbar', () => {
  ...
  describe('Display', () => {
    ...
    it('should show navigation links', () => {
      render(<Navbar />);
      expect(screen.getByRole('link', { name: /home|tasks/i })).toBeInTheDocument();
    });
  });
  ...
  describe('Loading State', () => {
    it('should show loading indicator when fetching auth status', () => {
      ...
      expect(document.querySelector('[aria-busy="true"]') || document.querySelector('.animate-spin')).toBeDefined();
    });
  });
