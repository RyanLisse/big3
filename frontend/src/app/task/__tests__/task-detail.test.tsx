...
describe('TaskDetailPage', () => {
  ...
  describe('Display', () => {
    ...
    it('should display task description', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Feature implementation task')).toBeInTheDocument();
      });
    });
  ...
  describe('Messages Display', () => {
    it('should display conversation messages', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/I will create the feature/i)).toBeInTheDocument();
      });
    });
  ...
  describe('Tool Events Panel', () => {
    it('should display tool events timeline', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText(/events/i) || screen.getByText(/timeline/i)).toBeDefined();
      });
    });
    ...
    it('should show different event types (status, shell, etc)', async () => {
      ...
      await waitFor(() => {
        expect(document.querySelector('[data-testid="tool-events"]')).toBeDefined();
      });
    });
  });
  ...
  describe('Realtime Updates', () => {
    it('should subscribe to task updates via Inngest', async () => {
      ...
      await waitFor(() => {
        expect(document.querySelector('[data-testid="task-detail"]')).toBeDefined();
      });
    });
