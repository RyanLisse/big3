...
vi.mock('@/src/hooks/use-github-auth', () => ({
  useGitHubAuth: vi.fn(() => ({
    ...
    repositories: [
      { name: 'main-repo', full_name: 'owner/main-repo', url: 'https://github.com/owner/main-repo' },
      { name: 'test-repo', full_name: 'owner/test-repo', url: 'https://github.com/owner/test-repo' },
    ],
    isLoading: false,
    error: null,
    login: vi.fn(),
