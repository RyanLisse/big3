...
import { ExecutionService, ExecutionServiceLive } from "../src/services/ExecutionService.js"
...
const MockBrowserService = Layer.succeed(BrowserService, {
  navigate: (url: string) => Effect.succeed(void 0),
...
describe("ExecutionService", () => {
  ...
  it("should continue execution even if a batch fails", async () => {
    ...
    const result = await Effect.runPromise(program.pipe(Effect.provide(FailingLayer)))
